...
/// Страница деталей пациента - пример вертикальной навигации через GoRouter (context.push)
          ...
          children: [
              ...
              _buildSection(
                ...
                children: [
                  ...
                  if (patient.allergies != null && patient.allergies!.isNotEmpty)
                    _buildInfoRow('Аллергии', patient.allergies!, isWarning: true),
                ],
              ),
            ...
            if (vitals.isNotEmpty)
              _buildSection(
                ...
                children: vitals.take(3).map((vital) => Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
                  child: VitalCard(vital: vital, patientId: patient.id),
                )).toList(),
              ),
            ...
            if (consultations.isNotEmpty)
              _buildSection(
                ...
                children: consultations.take(3).map((consultation) => Card(
                  child: ListTile(
